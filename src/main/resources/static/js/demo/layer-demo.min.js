		...
		htdy : $("html, body")
			...
			$("#chutiyan>a")
					.on(
							"click",
							function() {
								var t = $(this), a = t.index(), r = e.demo1
										.children("p").eq(a), n = r.position().top;
								...
								case 12:
									...
									break;
								case 13:
									layer.tips("我是另外一个tips，只不过我长得跟之前那位稍有些不一样。",
											this, {
												tips : [ 1, "#3595CC" ],
												time : 4e3
											});
